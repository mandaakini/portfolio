...
export default function HarmonySection() {
  return (
    <section
      id="harmony"
      className="relative flex min-h-[calc(100svh+1.5rem)] scroll-mt-20 items-center overflow-hidden bg-oxblood px-6 pb-16 pt-10 text-porcelain sm:px-8 sm:pb-20 sm:pt-12"
    >
