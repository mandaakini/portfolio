export default function Footer() {
  return (
    <footer className="relative overflow-hidden border-t border-cream/10 bg-deep-espresso py-4 text-cream">
      ...
      <div
        aria-hidden="true"
        className="absolute -right-20 -top-20 h-40 w-40 rounded-full bg-rosewood/10 blur-3xl"
      />

      <div className="relative mx-auto flex max-w-8xl flex-col items-center justify-between gap-3 px-6 text-center sm:flex-row sm:px-8 sm:text-left lg:px-12">
